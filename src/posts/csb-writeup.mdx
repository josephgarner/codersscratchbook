...
<Swiper navigation={true} modules={[Navigation]} className="mySwiper">
  <SwiperSlide>
    <img src="/assets/cbs-writeup/old_layout.png" width={"100%"} height={400} style={{ objectFit: "cover" }} />
  </SwiperSlide>
  <SwiperSlide>
    <img src="/assets/cbs-writeup/new_layout.png" width={"100%"} height={400} style={{ objectFit: "cover" }} />
  </SwiperSlide>
</Swiper>
<br />
